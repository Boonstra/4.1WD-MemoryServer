memoryScript=function(){var t={};return t.init=function(){$$(document).addEvent("click:relay(.new-game-button)",function(e){e.preventDefault(),t.startNewGame()}),t.startNewGame(),t.openSocket()},t.startNewGame=function(){t.currentGame=new t.Game(4,4)},t.openSocket=function(){t.socket=io.connect("http://localhost:3000"),t.socket.on("highScores",function(e){t.updateHighScoresList(e)})},t.updateHighScoresList=function(t){var e,n,o,a=$$(".high-scores-list");for(a.set("html",""),e=new Element("tr"),e.adopt(new Element("th",{text:"#"})),e.adopt(new Element("th",{text:"Name"})),e.adopt(new Element("th",{text:"Score"})),e.adopt(new Element("th",{text:"Time"})),a.adopt(e),o=0;o<t.length;o++)n=t[o],e=new Element("tr"),e.adopt(new Element("td",{text:o+1})),e.adopt(new Element("td",{text:n.name})),e.adopt(new Element("td",{text:n.score})),e.adopt(new Element("td",{text:n.time})),a.adopt(e)},window.addEvent("domready",function(){t.init()}),t}();
!function(){var e=memoryScript;e.Game=function(n,t){this.cellCountX=n,this.cellCountY=t,this.players=[],this.currentPlayerIndex=0,this.turnedCardElements=[],this.turnTimer=null,this.loadingBarAnimation=null,this.startTime=Math.round((new Date).getTime()/1e3),this.endOfGameScore=-1,this.endOfGameTime=-1,this.$board=$$(".board"),this.$turnTimeSlider=$$(".turn-time-slider"),this.$turnTimeSliderValue=$$(".turn-time-slider-value"),this.$currentPlayerNameField=$$(".current-player-name"),this.$playerScores=$$(".player-scores"),this.$loadingBarBackground=$$(".loading-bar-background"),this.$loadingBarProgress=$$(".loading-bar-progress"),this.$endOfGameScreen=$$(".end-of-game-screen"),this.$winnerPlayerNameContainer=this.$endOfGameScreen.getElement(".winner-player-name-input-container"),this.$winnerPlayerNameInput=this.$endOfGameScreen.getElement(".winner-player-name-input"),this.$winnerPlayerNameInputButton=this.$endOfGameScreen.getElement(".winner-player-name-input-button"),this.$playerScores.set("text",""),this.players.push(new e.Player("Player 1")),this.currentPlayerIndex=Math.floor(Math.random()*this.players.length),this.resetEndOfGame(),this.nextTurn(!0),this.prepareBoard(this.cellCountX,this.cellCountY),this.$turnTimeSlider.addEvent("change",function(){this.handleTurnTimeSliderChange()}.bind(this)),this.$board.addEvent("click:relay(.card-container)",function(e,n){this.handleCardClick(n)}.bind(this)),this.$winnerPlayerNameInputButton.addEvent("click",function(){this.submitScore(this.$winnerPlayerNameInput.get("value")[0],this.endOfGameScore,this.endOfGameTime)}.bind(this))}}();
...
!function(){var e=memoryScript;e.Game.prototype.isEndOfGame=function(){return this.$board.getElements(".card-container.flipped")[0].length>=this.cellCountX*this.cellCountY},e.Game.prototype.endOfGame=function(){var e,t=this.$endOfGameScreen.getElement(".end-of-game-screen-content"),n=this.$endOfGameScreen.getElement(".winner-player-name"),i=this.$endOfGameScreen.getElement(".total-play-time-container"),r=i.getElement(".total-play-time"),a=this.$endOfGameScreen.getElement(".total-score-container"),s=a.getElement(".total-score"),o=-1,m=Math.round(100*((new Date).getTime()/1e3-this.startTime))/100,h=[],l=" ";for(e=0;e<this.players.length;e++)this.players[e].score>o?(h=[this.players[e]],o=this.players[e].score):this.players[e].score==o&&h.push(this.players[e]);for(e=0;e<h.length;e++){l+=h[e].name;{if(!(e<h.length-1))break;l+=" and "}}this.endOfGameScore=o,this.endOfGameTime=m,n.set("text",l),r.set("text",m),s.set("text",o),this.$endOfGameScreen.setStyle("width",this.$board.getSize()[0].x),this.$endOfGameScreen.setStyle("height",this.$board.getSize()[0].y),this.$endOfGameScreen.setStyle("top",-this.$board.getSize()[0].y),t.setStyle("margin-top",(this.$board.getSize()[0].y-t.getSize()[0].y)/2),new Fx.Tween(this.$endOfGameScreen[0],{duration:2e3,transition:"bounce:out",property:"top"}).start(-this.$board.getSize()[0].y,0)},e.Game.prototype.submitScore=function(e,t,n){new Fx.Tween(this.$winnerPlayerNameContainer[0],{duration:200,transition:"linear",property:"height"}).start(this.$winnerPlayerNameContainer.getSize()[0].y,0),socket.emit("submitScore",{name:e,score:t,time:n})},e.Game.prototype.resetEndOfGame=function(){this.$endOfGameScreen.setStyle("height",0)}}();
